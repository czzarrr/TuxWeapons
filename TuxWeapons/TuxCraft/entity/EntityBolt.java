...
public class EntityBolt extends Entity implements IProjectile {
	...
	public EntityBolt(World par1World, EntityLivingBase par2EntityLiving,
				...
				if (var4.entityHit != null) {
					...
					if (var4.entityHit.attackEntityFrom(var21, var23)) {
						...
						if (this.type == 1) {
							...
							((EntityLiving) var4.entityHit)
									.addPotionEffect(new PotionEffect(
											Potion.poison.id, 200, 1));
						}
			...
			if (this.getIsCritical()) {
				for (var9 = 0; var9 < 4; ++var9) {
					this.worldObj.spawnParticle("crit", this.posX
							+ this.motionX * var9 / 4.0D, this.posY
							+ this.motionY * var9 / 4.0D, this.posZ
							+ this.motionZ * var9 / 4.0D, -this.motionX,
