...
public class EntityEagleArrow extends Entity implements IProjectile {
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	private int inTile;
	...
	public EntityEagleArrow(World par1World) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	}

	public EntityEagleArrow(World par1World, double par2, double par4,
			double par6) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public EntityEagleArrow(World par1World,
			EntityLivingBase par2EntityLivingBase, float par3, int par4) {
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = par2EntityLivingBase;
	...
	public void onUpdate() {
		...
		if (this.inGround) {
			...
			if (this.getIsCritical()) {
				for (l = 0; l < 4; ++l) {
					this.worldObj.spawnParticle("magicCrit", this.posX
							+ this.motionX * (double) l / 4.0D, this.posY
							+ this.motionY * (double) l / 4.0D, this.posZ
							+ this.motionZ * (double) l / 4.0D, -this.motionX,
