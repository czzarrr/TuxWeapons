...
public class EntitySpear extends Entity implements IProjectile {
	...
	public EntitySpear(World par1World, EntityLivingBase par2EntityLiving,
	...
	public EntitySpear(World par1World, EntityLivingBase par2EntityLiving,
			float par3, ItemStack par4ItemStack, int par5) {
		...
		par1NBTTagCompound.setCompoundTag("Stack",
				par4ItemStack.writeToNBT(new NBTTagCompound()));
	}
			...
			if (var4 != null) {
				if (var4.entityHit != null) {
					...
					if (var4.entityHit instanceof EntityLiving) {
						...
						var4.entityHit.attackEntityFrom(var22, var24);
	...
	public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound) {
		...
		// par1NBTTagCompound.setCompoundTag("Stack", this.stack.writeToNBT(new
		// NBTTagCompound()));
	}
	...
	public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound) {
		...
		// this.stack =
		// ItemStack.loadItemStackFromNBT(par1NBTTagCompound.getCompoundTag("Stack"));
	...
	public static ItemStack getStack(EntitySpear entity) {
		NBTTagCompound par1NBTTagCompound = entity.getEntityData();
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer) {
		...
		if (this.inGround && this.arrowShake <= 0) {
			if (!this.worldObj.isRemote) {
				...
				if (par1EntityPlayer.capabilities.isCreativeMode != true) {
					par1EntityPlayer.inventory.addItemStackToInventory(this
							.getStack(this));
					this.setDead();
					this.kill();
					this.isDead = true;
